% gourmand(SECTION) | User Commands
%
% "September 29 2024"
...
gourmand - program to do something

# SYNOPSIS

**gourmand** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**gourmand** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **gourmand** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**gourmand** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    gourmand. See **foo.conf**(5) for further details.
...
**gourmand** provides some return codes, that can be used in scripts:
...
Winship Varner <winshipvarner@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Winship Varner
